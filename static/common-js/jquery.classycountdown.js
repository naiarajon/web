...
(function($) {
    $.fn.ClassyCountdown = function(options, callback) {
        var element = $(this);
        var DaysLeft, HoursLeft, MinutesLeft, secondsElapsed;
        var secondsElapsed;
        var isFired = false;
        var settings = {
            from: undefined,
        ...
        function secondsToDHMS() {
            DaysLeft = Math.floor(secondsElapsed / 86400);
            HoursLeft = Math.floor((secondsElapsed % 86400) / 3600);
            MinutesLeft = Math.floor(((secondsElapsed % 86400) % 3600) / 60);
            SecondsLeft = Math.floor((((secondsElapsed % 86400) % 3600) % 60) % 60);
        }

        function doTick() {
            secondsElapsed = (new Date().getTime() - settings.from)/1000
            secondsToDHMS();
